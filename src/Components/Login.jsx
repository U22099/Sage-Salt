...
function Login() {
  return (
    <form action="/" method="POST" className="bg-primary-color flex flex-col justify-center mx-auto rounded-xl p-[10px] py-[20px] md:p-[40px] w-max h-max gap-[20px]">
        <h1 className=" w-[100%] flex justify-start items-center text-[2em] text-white">Log In</h1>
        <input autoFocus type="email" placeholder="Email or phone number" className=" w-[250px] md:w-[300px] focus:border-[red] focus:border-4px focus:outline-none rounded-xl p-[10px] text-[1.2em] text-black" required/>
        ...
        <button type="submit" className="mx-auto flex justify-center items-center bg-primary-color text-white rounded-md shadow-xl w-[90%] h-[40px] text-[1.2em]">Log In</button>
        <div className="flex flex-col justify-center gap-[20px]">
            <h1 className="text-white mx-auto text-[1.4em]">----- Log In With -----</h1>
