...
function DefaultCard(props){
    return(
        <div className="grid grid-cols-1 md:grid-cols-3 md:cols-span-3 gap-[20px] text-center w-[90vw] mx-auto mt-[30px]">
            <div className="rounded-lg bg-white w-[200px] mx-auto md:w-[370px] p-[20px] h-[350px] shadow-2xl text-black flex flex-col justify-center">
